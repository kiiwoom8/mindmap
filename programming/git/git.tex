...
\begin{inctext}
    \begin{tikzpicture}
        ...
        \begin{scope}[
            ...
            \node[root concept, fill=white](git){
                \href{../programming.pdf}{Git}
            }
            child{
                    node{
                            \href{https://www.atlassian.com/git/tutorials/using-branches/git-merge}{Git Merge}
                        }
                }
            ;
        \end{scope}
        ...
        \begin{pgfonlayer}{foreground}
            \node[text width=1cm, text height=1cm,yshift=-1cm] at (git) {
                \href{../../mindmap.pdf}{\includegraphics[width=1cm,height=1cm]{../../image/git.png}}
            };
        \end{pgfonlayer}
    \end{tikzpicture}
\end{inctext}
